 ...
 */
public class kNearestNeighborAlgorithmTest extends ActivityInstrumentationTestCase2<MainActivity> {

    private Solo solo;

    public kNearestNeighborAlgorithmTest() {
    ...
    public void testSimpleMatch_Simple() throws IOException {
        ...
        AbstractLocaliserAlgorithm nna = new kNearestNeighborsAlgorithm(new SimpleComporator());
